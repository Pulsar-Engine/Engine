...
GraphicsPipeline::GraphicsPipeline(std::unique_ptr<Device> &device, std::unique_ptr<Swapchain> &swapchain) : _device(device)
{
    ...
    vertShaderStageInfo.module = vert.getPrimitive();
    vertShaderStageInfo.pName = "main";

    VkPipelineShaderStageCreateInfo fragShaderStageInfo{};
    fragShaderStageInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
    fragShaderStageInfo.stage = VK_SHADER_STAGE_FRAGMENT_BIT;
    fragShaderStageInfo.module = frag.getPrimitive();
    ...
    if (vkCreatePipelineLayout(_device->getPrimitive(), &pipelineLayoutInfo, nullptr, &pipelineLayout) != VK_SUCCESS) {
    ...
    pipelineInfo.renderPass = _renderPass->getPrimitive();
    pipelineInfo.subpass = 0;
    pipelineInfo.basePipelineHandle = VK_NULL_HANDLE;
    pipelineInfo.basePipelineIndex = -1;

    if (vkCreateGraphicsPipelines(_device->getPrimitive(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &_primitive) != VK_SUCCESS) {
